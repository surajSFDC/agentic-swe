...
12. **Optional cross-run learning**: If the team maintains `docs/agentic-swe/PLAYBOOK.md`, append a dated entry using `.claude/templates/playbook-entry.md`. This is **optional**, should be **human-reviewed** before commit, and must not block merge.
