...
See `.claude/references/root-cause-tracing.md` for deep techniques.
...
See `.claude/references/condition-based-waiting.md` for detailed patterns.
...
See `.claude/references/defense-in-depth.md` for layer details and examples.

## Scope

This reference is consumed by:

- `.claude/phases/validation.md` (when tests fail during validation)
- `.claude/phases/escalate-validation.md` (three-strike rule for escalation)
- `.claude/phases/implementation.md` (debugging during development)
- `.claude/agents/developer-agent.md` (working method)

Related: `.claude/references/root-cause-tracing.md`, `.claude/references/defense-in-depth.md`, `.claude/references/condition-based-waiting.md`
