...
Consumed by `.claude/references/debugging-playbook.md` (condition-based waiting section).

Related: `.claude/references/root-cause-tracing.md`, `.claude/references/defense-in-depth.md`
