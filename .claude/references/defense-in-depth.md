...
Consumed by `.claude/references/debugging-playbook.md` (defense-in-depth section).

Related: `.claude/references/root-cause-tracing.md`, `.claude/references/condition-based-waiting.md`
