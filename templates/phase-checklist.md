...
- does the artifact contain executable evidence (commands, output, exit codes), not just narrative? See `${CLAUDE_PLUGIN_ROOT}/references/verification-standard.md`
